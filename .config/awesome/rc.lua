...
-- This is the default browser to run.
browser = "firefox"
...
globalkeys = gears.table.join(
    ...
    awful.spawn.with_shell("pactl set-sink-volume @DEFAULT_SINK@ +3%") end),
    ...
    awful.spawn.with_shell("xbacklight +15") end),
